...
/**
 * Notificaciones tipo "toast" (avisos breves no bloqueantes): éxito al guardar, error, etc. Para
 * confirmaciones/entradas usa diálogos (`lib/dialogs`). Uso en cualquier componente:
