...
/**
 * Cáscara (shell) de la app de escritorio: menú lateral + cabecera + área de contenido (router-view).
 * Es infraestructura PERMANENTE — el agente NO la sustituye: añade pantallas como vistas en ./views y
 * las registra en router.ts (y en el menú de AppSidebar.vue). El contenido de cada pantalla vive en su
 * vista, no aquí. Mantén el montaje en #app.
 */
